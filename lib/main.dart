...
import 'package:flutter_application_1/data/repositories/artists/artist_repository_firebase.dart';
...
List<InheritedProvider> get devProviders {
  ...
  return [
    ...
    Provider<SongRepository>(
      create: (_) => SongRepositoryMock(),
    ), // MockSong Repo
    // Firebase Repo
    Provider<SongRepositoryFirebase>(create: (_) => SongRepositoryFirebase()),
